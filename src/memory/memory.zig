...
pub fn MemoryAllocator(comptime config: MemoryConfig) type {
    ...
    return struct {
        ...
        pub fn init(base_allocator: std.mem.Allocator) !Self {
            return Self{
                .allocator = switch (config.strategy) {
        ...
        pub fn deinit(self: *Self) void {
            switch (config.strategy) {
                .arena => self.allocator.deinit(),
                .general_purpose => _ = self.allocator.deinit(),
                .fixed_buffer => {},
                .stack => {},
                .adaptive => self.allocator.deinit(),
            }
        }
        ...
        pub fn free(self: *Self, memory: anytype) void {
            ...
            self.allocator.allocator().free(memory);
